...
function App() {
  ...
  const steps = [
    ...
    },
    {
      ...
      content:
        "Once you have selected your area and topic, the map will display the data. You can zoom in and out, and pan around by clicking and dragging.",
    },
    {
      selector: ".legend-tour-step",
      content:
        "This is the legend. It shows the range of values for your selected topic.",
    },
  ];
